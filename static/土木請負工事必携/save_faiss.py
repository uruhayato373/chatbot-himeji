...
# 日本語のディレクトリ名はエラーになる
VECTORSTORE_DIR = "vectorstore/faiss/hikkei"
...
if __name__ == "__main__":
    ...
    for i, file in enumerate(pdf_files):
        ...
        print(formatted_docs[0].metadata['source'])
        print(formatted_docs[0].metadata['page'])
