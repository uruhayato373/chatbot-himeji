...
def format_metadata(org_docs: Iterable[Document], page_prefix: str) -> Iterable[Document]:
    ...
    for doc in docs:
        ...
        new_page = f'{page_prefix}-{str(doc.metadata["page"]+1)}'
...
if __name__ == "__main__":
    ...
    for i, file in enumerate(pdf_files):
        ...
        formatted_docs = format_metadata(docs, page_prefix)
